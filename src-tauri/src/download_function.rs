...
pub fn download_file(url: &str, output: &str, num_threads: usize) -> Result<(), Box<dyn Error + Send + Sync>> {
    ...
    println!("Downloading {} bytes using {} threads...", total_size, num_threads);
